            ...
            <div className={`bg-gradient lg:hidden bg-opacity-90 z-50 top-0 left-0 fixed p-4 h-screen w-full bg-black text-white grid ${toggleIcon ? ' block ' : ' hidden' }`} >
                        ...
                        <div >
                            <nav className=" ham m-3 grid  align-content-around justify-center font-medium text-2xl ">
                                ...
                                <Link activeClass='active' to="about-me" spy={true} smooth={true} offset={-50} duration={500} className="py-2 hover:text-yellow-300 cursor-pointer" onClick={handleClickIcon}>About Me</Link>
                                <Link activeClass='active' to="skills" spy={true} smooth={true} offset={-50} duration={500} className="py-2 hover:text-yellow-300 cursor-pointer" onClick={handleClickIcon}>Skills</Link>
                                <Link activeClass='active' to="resume" spy={true} smooth={true} offset={-50} duration={500} className="py-2 hover:text-yellow-300 cursor-pointer" onClick={handleClickIcon}>Resume</Link>
                                <Link activeClass='active' to="projects" spy={true} smooth={true} offset={-50} duration={500} className="py-2 hover:text-yellow-300 cursor-pointer" onClick={handleClickIcon}>Projects</Link>
                                <Link active Class='active' to="testimonials" spy={true} smooth={true} offset={-50} duration={500} className="py-2 hover:text-yellow-300 cursor-pointer" onClick={handleClickIcon}>Testimonials</Link>
                                <Link activeClass='active' to="contact-me" spy={true} smooth={true} offset={-50} duration={500} className="py-2 hover:text-yellow-300 cursor-pointer" onClick={handleClickIcon}>Contact Me</Link>
                            </nav>
                        </div>
